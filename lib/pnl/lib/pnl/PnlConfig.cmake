...
if (MSVC)
    ...
    set(PNL_LIBRARY ${pnl_root_dir}/lib/libpnl.so)
endif(MSVC)
...
if (PNL_FOUND)
    if (MSVC)
        ...
        set(PNL_INCLUDE_DIRS ${PNL_INCLUDE_DIR} )
        set(PNL_LIBRARIES ${PNL_LIBRARY} /usr/lib/libf77blas.so.3gf;/usr/lib/libatlas.so.3gf;/usr/lib/liblapack.so;/usr/lib/libf77blas.so.3gf;/usr/lib/libatlas.so.3gf;m;dl)
    endif(MSVC)
